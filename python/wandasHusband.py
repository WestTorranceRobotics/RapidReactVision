...
import numpy as np
import time
# https://docs.wpilib.org/en/stable/docs/software/vision-processing/wpilibpi/basic-vision-example.html for most of the file
# https://robotpy.readthedocs.io/en/stable/vision/code.html for showing me that you have to use CameraServer.getInstance()
